...
# Generating marker genes for scRNA-seq
```{r}
Idents(seu) <- 'global.cluster2'
sc_markers <- FindAllMarkers(seu)
```
...
out: This should be a string of the home directory you would like to store your object in
